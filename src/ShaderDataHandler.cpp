...
void
ShaderDataHandler::updateData(const string& _uniformName, const sVec2D< GLfloat >& _value) {
...
void
ShaderDataHandler::updateData(const string& _uniformName, const sVec3D< GLfloat >& _value) {
...
void
ShaderDataHandler::updateData(const string& _uniformName, const sVec4D< GLfloat >& _value) {
