...
public:
	 ...
	 */
	void prepareRoom(vboUsage _u = STATIC_DRAW) { __gpu.prepareRoom(*this, _u); }
	 ...
	 */
	void sendData(short unsigned _t, void* _d) { __gpu.sendData(*this, _t, _d); }
	
	/**
	 * Queries OpenGL to get the amount of used memory.
	 * @return Size of buffer.
	 */
	unsigned getBufferSize() { return __gpu.getBufferSize(*this); }
	
	/**
	 * Deletes the buffers.
	 */
	void deleteBuffers() { __gpu.deleteBuffers(*this); }
	 ...
	 */
	void * mapBuffer(short unsigned _t, unsigned _a) { return __gpu.mapBuffer(*this, _t, _a); }
	 ...
	 */
	bool unmapBuffer(short unsigned _t) { return __gpu.unmapBuffer(*this, _t); }
	
	/**
	 * Binds specified VBO object.
	 * @param target Buffer to bind.
	 */
	void bind(short unsigned _t) { __gpu.bind(*this, _t); }
	
	/**
	 * Unbinds specified VBO object.
	 * @param target Buffer to unbind.
	 */
	void unbind(short unsigned _t) { __gpu.unbind(*this, _t); }
